...
| SRBench seed provenance | The 100 benchmark seeds are `RandomState(42).randint(0,32767,100)` from SRBench (2020). All SR methods use MT19937. 15-bit seeds + poor diffusion → ~1.6× inflated results. Hyperparameter overfitting to these seeds is the likely mechanism. | [srbench_seed_provenance.md](./srbench_seed_provenance.md) |
